...
const withWarnings: RecipeChecksResult = {
  ...
  results: [
    ...
    },
    {
      ...
      severity: 'warning',
      selector: 'meta[name="description"]',
      assertion: { type: 'emptyAttributeCountEquals', attribute: 'content', value: 0 },
      message: 'Description is 178 chars, recommended max is 160.'
    },
    {
      id: 'chk-4',
      name: 'Canonical URL set',
    ...
    },
    {
      ...
      selector: 'meta[property="og:description"]',
      assertion: { type: 'exists' },
      message: 'OG description is missing or empty.'
    },
    {
      id: 'chk-7',
      name: 'Twitter card defined',
...
const withErrors: RecipeChecksResult = {
  ...
  results: [
    ...
    },
    {
      ...
      selector: 'meta[property="og:description"]',
      assertion: { type: 'exists' },
      message: 'Open Graph tags are missing entirely.'
    },
    {
      id: 'chk-7',
      name: 'Twitter card defined',
      ...
      selector: 'meta[name="twitter:card"]',
      assertion: { type: 'exists' },
      message: 'Defaulting to summary; consider using summary_large_image.'
    }
  ]
};
